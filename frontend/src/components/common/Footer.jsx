...
export function Footer() {
  return (
    <div>
      <footer className="w-full bg-[#1A1A1D] mt-8">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="py-14 flex justify-evenly items-center">
            <div className="ml-20 col-span-full xl:col-span-3 relative bg-gradient-to-tr from-indigo-600 to-violet-600 rounded-2xl gap-12 p-6 xl:w-79 h-96 flex flex-col justify-center items-center">
              <Link
                to="/"
                className="flex justify-center z-50 lg:justify-start"
              >
                <img src={Logo} alt="logo" className="w-[30rem]" />
              </Link>
              <p className="text-center text-gray-200">
                From startup to scale-up, we’re your growth catalyst. Our
                diverse team brings expertise across industries to transform
            ...
            <div className="flex flex-wrap justify-between w-full mt-8 gap-x-8 text-sm">
            {/* Quick Links */}
            <div className="flex flex-col space-y-4 pl-90">
                <h4 className="text-lg text-amber-50 font-bold mb-9 text-center xl:text-left">
                  Quick Links
                </h4>
                <div className="flex gap-6 xl:gap-12 max-xl:justify-center">
                  <ul className="text-gray-600 transition-all duration-500 grid gap-6">
                    ...
                    <li>
                      <a href="javascript:;">Investor Application </a>
                    </li>
                    <li>
                      <a href="javascript:;">Job Application</a>
                    </li>
                    <li>
                      <a href="javascript:;">Apply to Startup Accelerator</a>
                    </li>
                    <li>
                      <a href="javascript:;">Career Accelerator Program</a>
                    </li>
                    <li>
              ...
              <div className="flex flex-col space-y-2">
                <h4 className="text-lg justify-start text-amber-50 font-bold mb-9 text-center xl:text-left">
                  Legal
                </h4>
                <ul className="text-gray-600 transition-all duration-500 grid gap-6">
                  <li>
                  ...
                  <li>
                    <a href="javascript:;">Decentralized Intelligence Agency</a>
                  </li>
                </ul>
              <div className="flex gap-6 mt-6">
                <input
                  type="text"
                  name="email"
                  className="py-2 px-4 border border-gray-300 shadow-sm h-14 text-lg text-white rounded-full w-full  xl:w-64 placeholder:text-white focus:outline-none"
        ...
        <div className="py-4 bg-indigo-50">
          <div className="flex items-center justify-center">
            <span className="text-sm text-gray-800 ">
              ...
              <a href="https://persistventures.com/">Persist ventures</a>
            </span>
          </div>
        </div>
      </footer>
